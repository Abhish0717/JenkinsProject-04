...
public class TimeTableCtl extends BaseCtl {
	...
	/**
	 * Handles HTTP GET requests. If an 'id' parameter is present (>0), loads the
	 * corresponding timetable for editing/view and forwards to view.
	 *
	 * @param request  current {@link HttpServletRequest}
	 ...
	 * <ul>
	 * <li>Save � checks for duplicate timetable entries (by
	 * course/date/subject/semester) and adds if unique.</li>

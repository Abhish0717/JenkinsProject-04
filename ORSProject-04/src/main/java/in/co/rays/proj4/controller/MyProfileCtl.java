 ...
 * from request parameters, and delegates update operations to
 * {@link UserModel}. It also supports navigation to change-password
 * functionality.
 * <p>
 * Typical operations:
 * <ul>
...
public class MyProfileCtl extends BaseCtl {
	 ...
	 * <ul>
	 * <li>Skips validation for Change Password operation or when operation is
	 * null.</li>
	...
	/**
	 * Handles HTTP GET requests. Loads the current user's profile from session and
	 * retrieves the up-to-date data from {@link UserModel} for display.
	 *

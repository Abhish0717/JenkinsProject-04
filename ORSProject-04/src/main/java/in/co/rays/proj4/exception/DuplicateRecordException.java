 ...
 *
 * Typical scenarios: - Trying to register a user with an email/login that
 * already exists - Adding a role, subject, or course that has the same unique
 * name - Attempting to insert duplicate roll numbers in marksheets
 *

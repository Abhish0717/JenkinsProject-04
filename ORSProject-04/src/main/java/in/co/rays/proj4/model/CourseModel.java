...
public class CourseModel {
	 ...
	 * @throws ApplicationException     if a general application/database error
	 *                                  occurs
	 ...
	 * throws {@link DuplicateRecordException} if a different record with same name
	 * exists.
	 * </p>
	 *
	...
	/**
	 * Searches for courses matching the criteria provided in {@code bean}. If
	 * {@code pageSize} &gt; 0, results are paginated.
	 *
	 * @param bean     filter criteria; if {@code null} returns all records
	 * @param pageNo   page number (1-based) when paginating; ignored if pageSize is
	 *                 0

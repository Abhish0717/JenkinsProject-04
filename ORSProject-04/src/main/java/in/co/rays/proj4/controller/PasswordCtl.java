...
public class PasswordCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("code"))) {
			request.setAttribute("code", PropertyReader.getValue("error.require", "Reset Code"));
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("token"))) {
			request.setAttribute("token", PropertyReader.getValue("error.require", "Reset Token"));
			pass = false;
		}

...
<title>Add Password Reset</title>
...
<body>
	<form action="<%=ORSView.PASSWORD_CTL%>" method="post">
		...
		<div align="center">
			...
			<table>
				<tr>
					<th align="left">Reset Code<span style="color: red">*</span></th>
					<td><input type="text" name="code"
						placeholder="Enter Reset Code"
						value="<%=DataUtility.getStringData(bean.getResetCode())%>"></td>
				...
				<tr>
					...
					<td><input type="text" name="token"
						...
						value="<%=DataUtility.getStringData(bean.getResetToken())%>"></td>
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("token", request)%></font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" colspan="2"><input type="submit"
						name="operation" value="<%=PasswordCtl.OP_UPDATE%>"> <input
						type="submit" name="operation" value="<%=PasswordCtl.OP_CANCEL%>">
						<%
						} else {
						%>
					<td align="left" colspan="2"><input type="submit"
						name="operation" value="<%=PasswordCtl.OP_SAVE%>"> <input
						type="submit" name="operation" value="<%=PasswordCtl.OP_RESET%>">
						<%
						}
						%>
				</tr>

...
<html>
<head>
<title>Password Reset List</title>
...
<body>
	...
	<jsp:useBean id="bean" class="in.co.rays.proj4.bean.PasswordBean"
		scope="request"></jsp:useBean>

	<div align="center">
		<h1 align="center" style="margin-bottom: -15; color: navy;">Password Reset List</h1>
		...
		<form action="<%=ORSView.PASSWORD_LIST_CTL%>" method="post">
			...
			List<PasswordBean> nameList = (List<PasswordBean>) request.getAttribute("nameList");
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>Reset Code:</b></label> <input
						type="text" name="code" placeholder="Enter Reset Code"
						...
						type="submit" name="operation" value="<%=PasswordListCtl.OP_RESET%>"></td>
				</tr>
			</table>
			<br>
			<table border="1" style="width: 100%; border: groove;">
				<tr style="background-color: #e1e6f1e3;">
					...
					<th width="5%">S.No</th>
					<th width="25%">Reset Code</th>
					<th width="25%">User Name</th>
					<th width="30%">Reset Token</th>
					<th width="25%">Status</th>
					<th width="10%">Edit</th>
				</tr>
				<%
				while (it.hasNext()) {
					bean = (PasswordBean) it.next();
				%>
				<tr>
					...
					<td style="text-align: center;"><a
						href="PasswordCtl?id=<%=bean.getId()%>">Edit</a></td>
					<%
					}
					%>
			...
			<table style="width: 100%">
				<tr>
					...
					<td align="center" style="width: 25%"><input type="submit"
						name="operation" value="<%=PasswordListCtl.OP_NEW%>"></td>
					<td align="center" style="width: 25%"><input type="submit"
						name="operation" value="<%=PasswordListCtl.OP_DELETE%>"></td>
					<td style="width: 25%" align="right"><input type="submit"
						name="operation" value="<%=PasswordListCtl.OP_NEXT%>"
			...
			<table>
				<tr>
					<td align="right"><input type="submit" name="operation"
						value="<%=PasswordListCtl.OP_BACK%>"></td>
				</tr>
			</table>
			<%
			}

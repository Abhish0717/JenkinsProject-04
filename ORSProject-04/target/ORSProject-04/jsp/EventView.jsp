...
<body>
	<form action="<%=ORSView.EVENT_CTL%>" method="post">
		...
		<div align="center">
			...
			<table>
				<tr>
					<th align="left">Event Listener Code<span style="color: red">*</span></th>
					<td><input type="text" name="code"
						placeholder="Enter Event Listener Code"
						value="<%=DataUtility.getStringData(bean.getEventListenerCode())%>"></td>
				...
				<tr>
					<th align="left">Handler<span style="color: red">*</span></th>
					<td><input type="text" name="handler"
						placeholder="Enter Handler"
						value="<%=DataUtility.getStringData(bean.getHandler())%>"></td>
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("handler", request)%></font></td>
				</tr>
				<tr>

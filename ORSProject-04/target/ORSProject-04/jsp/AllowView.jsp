...
<%@page import="in.co.rays.proj4.controller.AllowCtl"%>
...
<body>
	<form action="<%=ORSView.ALLOW_CTL%>" method="post">
		...
		<div align="center">
			...
			<table>
				<tr>
					<th align="left">Allow Code<span style="color: red">*</span></th>
					<td><input type="text" name="code"
						placeholder="Enter Allow Code"
						value="<%=DataUtility.getStringData(bean.getAllowCode())%>"></td>
				...
				<tr>
					...
					<td><input type="text" name="source"
						...
						value="<%=DataUtility.getStringData(bean.getSource())%>"></td>
				...
				<tr>
					...
					<td align="left" colspan="2"><input type="submit"
						name="operation" value="<%=AllowCtl.OP_UPDATE%>"> <input
						type="submit" name="operation" value="<%=AllowCtl.OP_CANCEL%>">
						<%
						} else {
						%>
					<td align="left" colspan="2"><input type="submit"
						name="operation" value="<%=AllowCtl.OP_SAVE%>"> <input
						type="submit" name="operation" value="<%=AllowCtl.OP_RESET%>">
						<%
						}
						%>
				</tr>

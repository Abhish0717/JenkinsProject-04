	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Payment" : "Add Payment"%>
			</h5>
		</div>
			...
			<form action="<%=ORSView.PAYMENT_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Order ID <span
						class="text-danger">*</span></label> <input type="text" name="order"
						placeholder="Enter your Order ID" class="form-control"
						maxlength="100"
						value="<%=DataUtility.getStringData(bean.getOrderId())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("order", request)%></div>
				</div>
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Payment Method<span
						class="text-danger">*</span></label> <input type="text" name="method"
						placeholder="Enter your Payment Method" class="form-control"
						maxlength="200"
						value="<%=DataUtility.getStringData(bean.getPaymentMethod())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("method", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Payment Status<span
						class="text-danger">*</span></label> <input type="text" name="status"
						placeholder="Enter your Payment Status" class="form-control"
						maxlength="200"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="PaymentListCtl" class="btn btn-secondary ms-auto"> <i
					...
					<a href="PaymentCtl" class="btn btn-danger ms-auto"> <i
						class="bi bi-x-circle me-1"></i> Clear
					</a>
					<%
					}
					%>

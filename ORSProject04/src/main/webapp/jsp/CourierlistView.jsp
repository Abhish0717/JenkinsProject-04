<%@page import="com.sunilos.p4.ctl.CourierListCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.bean.CourierBean"%>
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-truck-fill me-2"></i>Courier Delivery List
			</h5>
			<a href="<%=ORSView.COURIER_CTL%>"
				class="btn btn-sm btn-light text-primary fw-semibold"> <i
				class="bi bi-truck me-1"></i> Add Courier Delivery
			</a>
		</div>
	</div>
